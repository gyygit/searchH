...
<body>
	 <ec:table tableId="test" action="${ctx}/user/list" method="post" items="users" var="var" view="sinova" width="99%" 
	...
	<form:form id="inputForm" modelAttribute="userInfo" action="${ctx}/user/create" method="post" >
		...
		<input id="button" type="button" value="提交" onclick="adUser.save();"/>&nbsp;	
	</form:form>
</body>
</html>
