// JavaScript Document
	...
	$(".leftTree").find("span").live("click",function(){
		...
		if(aHref=='null'){//判断导航name值是否为空
			...
			if(tabliTEXT.toLowerCase().indexOf(aText.toLowerCase())==-1){//判断主菜单是否有相同的菜单
				if(i<11){//判断主菜单是否超过10个
					$(".pcs_tab_ul").find("li:last").after("<li class='cur'><label title='"+ aText +"' name=" + aHref +"><span><em class='myspan'>"+aText+"</em><img src='images/yqClose.gif'/></span></label></li>");
					//清除当前选中状态
