 ...
 * @author think
 */
public class SinovaExTableToolbar extends TwoColumnRowLayout
{
	public SinovaExTableToolbar(HtmlBuilder html, TableModel model)
	{
		super(html, model);
	}
	...
	protected void columnRight(HtmlBuilder html, TableModel model)
	{
		...
		ToolbarBuilder toolbarBuilder = new SinovaExTableToolbarBuilder(html, model);
